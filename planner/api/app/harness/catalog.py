...
_CATALOG: list[CatalogAgent] = [
    ...
    CatalogAgent(
        ...
        kind="worker", model=SONNET,
        description="Sichert ZGPM-Methodentreue (MECE, Pyramid, Hypothesen, RACI).",
        mission="Plan/Arbeit gegen ZGPM + McKinsey-Prinzipien prüfen (MECE, Pyramid, Hypothesen, RACI-Konsistenz).",
    ...
    CatalogAgent(
        ...
        skills=["raci-validate", "rubric-eval"],
