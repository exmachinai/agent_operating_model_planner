...
from ..planning import zgpm_composer
from ..schemas.plan import Plan, PlanRevisionRequest
...
async def generate_plan(project_id: str) -> Plan:
    ...
    plan = zgpm_composer.compose(
        project, version=version, plan_id="plan_" + uuid.uuid4().hex[:12]
    )
