# HeyGen — Storyboard (intern, End-to-End) · selektive Screen-Zuordnung

**Format:** 16:9 · **Länge:** ~2:30 min · **Brand:** Navy #1E2761 · Gold #E6B32F (sparsam) · Vellum #FCFAF6 · Bricolage Grotesque / Inter
**Avatar:** Vollbild bei Intro/Outro (S1, S14); sonst Bild-in-Bild unten rechts, während der Screenshot die Fläche füllt.
**Prinzip:** Pro Szene wird **genau ein** Dashboard-Screenshot gezeigt — die Story führt selektiv durch Planung → Prototyp → Product.
...
## Schnitt-Hinweise
- **Phasen-Bauchbinde** je Übergang einblenden: „P · Planung", „P · Prototyp", „P · Product" (Gold).
- **S8** ist die Schlüssel-Sequenz: drei Plan-Ansichten langsam durchblenden (je ~6 s, Ken-Burns).
- **S11 (Canvas)** vollflächig zeigen — das ist der „Aha"-Moment (Agentenstruktur sichtbar). Leichter Pan über die Stages.
- Gold nur als Akzent (≤10 %); keine 100%-Versprechen; intern, kein externer CTA.
- Untertitel (DE) aktivieren.
